...
public class EntityDHDog extends EntityTameable{
	...
	public EntityDHDog(World w)
    {
        ...
        this.setTamed(false);
        this.dieWithOwner(this);
    }
	
	public void dieWithOwner(EntityTameable pet){
		if(pet.getOwner().isDead){
			pet.setDead();
		}
	}
	...
	protected void applyEntityAttributes()
    {
        ...
        if (this.isTamed())
        {
            ...
            this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(this.getOwner().getEntityAttribute(SharedMonsterAttributes.maxHealth).getBaseValue());
