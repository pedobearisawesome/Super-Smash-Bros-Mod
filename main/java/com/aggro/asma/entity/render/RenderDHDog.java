...
public class RenderDHDog extends RenderLiving {
    ...
    public RenderDHDog(ModelBase p_i1269_1_, ModelBase p_i1269_2_, float p_i1269_3_)
    {
     ...
     */
    protected float handleRotationFloat(EntityDHDog p_77044_1_, float p_77044_2_)
    {
     ...
     */
    protected int shouldRenderPass(EntityDHDog p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityDHDog p_110775_1_)
    {
    ...
    {
        return this.shouldRenderPass((EntityDHDog)p_77032_1_, p_77032_2_, p_77032_3_);
    }
    ...
    {
        return this.handleRotationFloat((EntityDHDog)p_77044_1_, p_77044_2_);
    }
    ...
    {
        return this.getEntityTexture((EntityDHDog)p_110775_1_);
    }
}
