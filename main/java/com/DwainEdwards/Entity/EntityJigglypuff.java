...
public class EntityJigglypuff extends EntityMob {

	private float heightOffset = 0.5f;
	private static final String __OBFID = "CL_00001682";
    
	public EntityJigglypuff(World par1World) {
		super(par1World);
    ...
    {
        return Main.MODID + ":Jiggly_Living";
    }
    ...
    {
        return Main.MODID + ":Jiggly_Death";
    }
