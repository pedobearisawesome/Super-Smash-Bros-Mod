...
public class EntityYoshi extends EntityMob {
	...
	public EntityYoshi(World par1World) {
	    ...
	    {
	        return Main.MODID + ":Yoshi_Living";
	    }

	    protected String getHurtSound()
	    {
	        return Main.MODID + ":Yoshi_Hurt";
	    }

	    
	    protected String getDeathSound()
	    {
	        return Main.MODID + ":Yoshi_Death";
	    }
