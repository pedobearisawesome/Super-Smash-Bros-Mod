...
public class EntitySamus extends EntityMob {

	private float heightOffset = 0.5f;
	private static final String __OBFID = "CL_00001682";
    
	public EntitySamus(World par1World) {
		super(par1World);
		 ...
		 this.tasks.addTask(2, new EntityAIAttackOnCollide(this, EntitySamus.class, 1.0D, false));
	        ...
	        this.tasks.addTask(8, new EntityAIWatchClosest(this, EntitySamus.class, 8.0F));
	        ...
	        this.targetTasks.addTask(2, new EntityAINearestAttackableTarget(this, EntitySamus.class, 0, true));
    ...
    {
        return Main.MODID + ":Samus_Living";
    }
