...
import com.DwainEdwards.armors.ItemmarioArmor;
	...
	public void onLivingUpdateEvent(final LivingEvent.LivingUpdateEvent event) {
		if (event.entity instanceof EntityPlayer) {
			...
			if (player.worldObj.isRemote) {
				...
				if (player.getCurrentArmor(3).getItem() instanceof  ItemmarioArmor 
				&& player.getCurrentArmor(2).getItem() instanceof  ItemmarioArmor 
				&& player.getCurrentArmor(1).getItem() instanceof ItemmarioArmor
				&& player.getCurrentArmor(0).getItem() instanceof ItemmarioArmor) {
			}
